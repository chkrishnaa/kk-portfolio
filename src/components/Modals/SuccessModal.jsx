      ...
      {showSuccess && (
        ...
        >
          ...
          >
            ...
            >
              <CheckCircle size={32} className="text-white"></CheckCircle>
            </motion.div>
            ...
            >
              Thankyou for reaching out! I'll get back to you within 24 hours.
            </motion.p>
            ...
            >
              <Sparkles size={24} className="text-yellow-500"></Sparkles>
            </motion.div>
          </motion.div>
        </motion.div>
      )}

  ...
  return (
    ...
    >
      <motion.div style={{ y }} className="absolute inset-0 overflow-hidden">
        <div
          className={`absolute top-40 right-1/4 w-72 h-72 rounded-full blur-3xl opacity-50 ${
            isDarkMode ? "bg-blue-500" : "bg-blue-400"
          }`}
        />
        <div
          className={`absolute bottom-40 left-1/4 w-64 h-64 rounded-full blur-3xl opacity-50 ${
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            Sills &
            <span className="text-blue-500 font-medium ml-2">Technologies</span>
          </motion.h2>
          ...
          >
            A comprehensive toolkits for building modern, scalable web
              ...
              <div className="space-y-4">
                {category.skills.map((skill, skillIndex) => (
                  <div key={skillIndex} className="group">
                    ...
                    >
                      <motion.div
                        variants={skilBarVariants}
                        initial="hidden"
                        animate={isInView ? "visible" : "hidden"}
                        custom={skill.level}
                        className={`h-full ${skill.color} rounded-full relative`}
                      >
                        <div className="absolute inset-0 bg-gray-50/20 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                      </motion.div>
                    </div>
                  </div>
                ))}
